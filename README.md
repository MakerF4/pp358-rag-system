...
Проект автоматически скачивает официальные русскую и узбекскую версии документа с lex.uz, очищает HTML, извлекает текст и таблицы, создаёт смысловые chunks, сохраняет версии документа с hash-значениями, строит VectorDB, выполняет hybrid retrieval и генерирует ответы с указанием source chunks через Streamlit UI.
...
- Отображение retrieved chunks в UI.
...
```env
DOCUMENT_URL=https://lex.uz/uz/docs/7158606?ONDATE=22.11.2025%2000
DOCUMENT_NAME=PP-358
